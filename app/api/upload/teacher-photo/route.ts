...
export async function POST(req: NextRequest) {
  try {
    const auth = await authorizeApiRequest(req, "teacher.edit")
    ...
    const result = await uploadToCloudinary(buffer, "educore/teachers", {
      resource_type: "image",
    ...
    console.error("[upload/teacher-photo]", err)
